-- Store the customer's UI language at checkout for localized status emails.

ALTER TABLE public.orders
  ADD COLUMN IF NOT EXISTS customer_locale TEXT NOT NULL DEFAULT 'he'
  CHECK (customer_locale IN ('en', 'he', 'ar'));

DROP FUNCTION IF EXISTS public.create_order_secure(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
...
REVOKE ALL ON FUNCTION public.create_order_secure(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) FROM PUBLIC;
GRANT  EXECUTE ON FUNCTION public.create_order_secure(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT) TO authenticated;
