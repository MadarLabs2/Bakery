-- Order scheduling: admin-configurable pickup/delivery weekdays + customer-selected fulfillment date.
...
-- Seed: Tuesday (2) and Friday (5) enabled for pickup + delivery; all other days disabled.
...
-- ── 2. Persist selected fulfillment date on orders ───────────────────────────
