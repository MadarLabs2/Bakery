...
export const dict: Dict = {
  brand: { en: "Al-Nour Gluten-Free Bakery", he: "מאפיית אלנור ללא גלוטן", ar: "مخبز النور بدون جلوتين" },
  tagline: { en: "Wholesome gluten-free baking, made with love.", he: "מאפים ללא גלוטן, אפויים באהבה.", ar: "مخبوزات خالية من الجلوتين، تُصنع بحب." },
  ...
  subscribeTitle: { en: "Get sweet offers in your inbox", he: "הצעות מתוקות במייל", ar: "احصل على عروض حلوة في بريدك" },
  subscribeDesc: { en: "Subscribe for new arrivals and exclusive discounts.", he: "הירשם להטבות ומבצעים בלעדיים.", ar: "اشترك للحصول على عروض حصرية ومنتجات جديدة." },
...
export function pickDesc(p: { description_en?: string | null; description_he?: string | null; description_ar?: string | null }, lang: Lang) {
  return (lang === "he" ? p.description_he : lang === "ar" ? p.description_ar : p.description_en) ?? "";
}
