    ...
    <footer className="mt-20 border-t bg-secondary/40">
      <div className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-3">
        ...
        <div className="text-sm space-y-2">
          ...
          <p className="flex items-center gap-2"><Phone className="h-4 w-4" /> 050-8588985</p>
          <p className="flex items-center gap-2"><Mail className="h-4 w-4" /> hello@alnour-bakery.com</p>
          <p className="flex items-center gap-2"><MapPin className="h-4 w-4" /> Israel</p>
        </div>
